...
Collection his firm buy arrive. Bill two management admit stock.', 7, True, NOW(), NOW());
INSERT INTO tweets (tweet_txt, user_id, is_delete, create_at, update_at) VALUES ('Responsibility yetmajority effort role tree kitchen. Tv western party necessary get benefit. Tell again institution pretty source PM.', 5, False, NOW(), NOW());
INSERT INTO tweets (tweet_txt, user_id, is_delete, create_at, update_at) VALUES ('Effort service machine its rest security.
Plan professor really floor part difference past. Dream relationship possible thus. Drug something with draw cell return share produce.', 9, False, NOW(), NOW());
INSERT INTO tweets (tweet_txt, user_id, is_delete, create_at, update_at) VALUES ('Tree ten more clearly account marriage lay. Challenge worry that. Own I believe share agreement another common.', 7, True, NOW(), NOW());
...
Audience address either parent nice machine. Fall follow public sign.', 3, True, NOW(), NOW());
INSERT INTO tweets (tweet_txt, user_id, is_delete, create_at, update_at) VALUES ('From something layarticle under gun want. Break else agreement health speak respond positive. Everybody return debate nature.', 5, True, NOW(), NOW());
INSERT INTO tweets (tweet_txt, user_id, is_delete, create_at, update_at) VALUES ('Put provide rich president ask join evening citizen. Herself car me game itself color already. Door authority card kindhuge despite eye.', 5, True, NOW(), NOW());
...
Magazine sea space quality. Blue trial north I. Space interview draw popular subject thing order over.', 9, True, NOW(), NOW());
INSERT INTO tweets (tweet_txt, user_id, is_delete, create_at, update_at) VALUES ('Trouble Democrat standard. Local past share great some. Argue he economic child least stand military.', 4, True, NOW(),NOW());
...
INSERT INTO connections (follower_id, followee_id, create_at) VALUES (3, 10, NOW());
...
INSERT INTO connections (follower_id, followee_id, create_at) VALUES (9, 10, NOW());
...
INSERT INTO reply (user_id, tweet_id, reply_text, create_at) VALUES (4, 10, 'Them account but use. Whether door skin experience though. Population give reach.', NOW());
...
INSERT INTO reply (user_id, tweet_id, reply_text, create_at) VALUES (8, 10, 'International worry happen order fund seem trial. Information approach east. Successful each under once keep.', NOW());
